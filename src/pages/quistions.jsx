      ...
      <>
        ...
        <div className="container px-4 md:px-0 max-w-9xl mx-auto mt-32">
          <div className="mx-0 sm:mx-6">
                ...
                <div className="w-full md:w-1/3 flex flex-col flex-grow flex-shrink">
                  ...
                  >
                    ...
                    <p className="text-gray-800 font-semiblod text-base px-6 mb-5 mt-3 text-2xl py-5">
                      <p>
                        المخدرات، تلك الوسيلة الخطرة التي تشكل تحديًا كبيرًا
                        للفرد والمجتمع. في هذا المقال، سنلقي نظرة عميقة على
                        أضرار المخدرات وكيف يمكن أن تؤثر على حياة الأفراد
                        والمحيط الاجتماعي بشكل كبير.
                      </p>
                      <p className="py-5">
                        يبدو أن الإغراءات المرتبطة بتعاطي المخدرات تجذب
                        الكثيرين، ولكن هل فكرنا أو وعينا بالتأثيرات الضارة التي
                        يمكن أن تخلفها؟ دعونا نتسلح بالمعرفة ونكشف عن الخيوط
                        الخفية لهذا العالم المظلم.
                      </p>
                      <p className="py-5">
                        الصور اللتي ستعرض في الاسفل توضح بعض اشهر انواع المخدرات
                        هيا . انغمسوا معنا في هذا الرحيل لاستكشاف الأضرار وراء
                        هذه الجدران الظاهرية، ولنتعلم كيف يمكننا تشجيع بيئة
                        خالية من المخدرات وتحفيز حياة صحية وإيجابية.
                      </p>{" "}
                    </p>
                  </div>
                  ...
                  <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                    ...
                    >
                      ...
                      <div className="w-full font-semiblod text-sm text-gray-900 px-6">
                        هو مخدر يستخرج من القنب الهندي (Cannabis Sativa) والتي
                        يتم زراعتها في المناطق الاستوائية والمناطق المعتدلة.
                        والحشيش هو السائل المجفف من المادة الصمغية بينما
                        الماريغوانا تستهلك بشكل عشب{" "}
                      </div>
                      ...
                      <p className="text-gray-800 font-serif text-base px-6 mb-5">
                        ...
                        >
                          <li>
                            يتم الشعور ببداية التأثيرات في غضون دقائق عند
                            التدخين، وحوالي 30 إلى 60 دقيقة عند تناولها بالفم.
                          </li>
                          <li>
                          ...
                          <li>
                            هبوط الضغط الإنتصابي (حدوث انخفاض في الضغط عند
                            الوقوف)
                          </li>
                ...
                >
                  <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                    ...
                    >
                      ...
                      <div className="w-full font-semiblod text-sm text-gray-900 px-6">
                        يعتبر أشد المنشطات الطبيعية. ويستخلص من أوراق نبات
                        الكوكة الذي ينمو في أمريكا الجنوبية حيث يمضغه الأهالي
                        وهو معروف لديهم منذ 5000 عام خاصة بوليفيا وبيرو أو
                        يضعونه مع الشاي ويشربونه للانتعاش والتغلب على التعب.{" "}
                      </div>
                      ...
                      <p className="text-gray-800 font-serif text-base px-6 mb-5">
                        ...
                        >
                          ...
                          <li>
                            يتم عادة إعادة تدوير الدوبامين في الخلايا التي
                            اطلقته.
                          </li>
                          <li>
                            يعمل الكوكايين على منع الدوبامين من إعادة التدوير
                            مما يؤدي إلى تراكم كميات كبيرة بين الخلايا العصبية
                ...
                >
                  <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                    ...
                    >
                      ...
                      <div className="w-full font-semiblod text-sm text-gray-900 px-6">
                        وهو أهم شبه قلوي مستخرج من الخشخاش المنوم. مخدر قوي
                        للجهاز العصبي المركزي ويسبب إدمانا جسميا ونفسيا قويا. في
                        الغرب، يصنف مع المخدرات.
                      </div>
                      ...
                      <p className="text-gray-800 font-serif text-base px-6 mb-5">
                        ...
                        >
                          <li>
                            خطورة الإصابة بعدوى خاصةً عند مشاركة الحقن، قد يصاب
                            المدمن بمرض نقص المناعة المكتسبة (الإيدز) أو التهاب
                            الكبد الوبائي.
                          </li>
                          <li>
                            مشاكل في الجلد بسبب تكرار الحقن كالدمامل والكدمات.
                          </li>
                          <li>خسارة في الوزن.</li>
                          <li>تلف حاجز وأغشية الأنف بسبب استنشاق الهيروين.</li>
                          <li>أمراض في القلب ومشاكل في ضغط الدم.</li>
                          <li>
                            مشاكل في العلاقات الاجتماعية؛ حيث يصبح المدمن
                            عدوانياً وغير عقلانياً بسبب الإدمان مما يدمر علاقاته
                            الإجتماعية، إضافةً إلى استعداده لارتكاب جريمة
                            ليستطيع تأمين حاجته من الهيروين.
                          </li>
                          <li>خفقان القلب (سرعة نبضات القلب)</li>
                        </ul>
                      </p>
                ...
                <div className="w-full md:w-1/2 p-6 flex flex-col flex-grow flex-shrink">
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="w-full font-semiblod text-sm text-gray-900 px-6">
                        منبه قوي جدا للجهاز العصبي المركزي ينتمي أساسًا إلى
                        العقارات الترفيهية ويُستخدم على نحو أقل ضمن علاجات الخط
                        الثاني لاضطراب نقص الانتباه مع فرط النشاط وفي حالات
                        السمنة.{" "}
                      </div>
                      ...
                      <p className="text-gray-800 font-serif text-base px-6 mb-5">
                        ...
                        >
                          <li>
                            يؤثر الميثامفيتامين على مواد كيميائية محدّدة في
                            الدماغ والجهاز العصبي بشكل مباشر، موهماً الشخص
                            بالشعور بالطاقة الجسدية والنشاط والسعادة والثقة
                            بالنفس، يقع المتعاطون للميثامفيتامين في حبائل
                            الإدمان بسرعة، ويحتاجون إلى جرعات أكبر في كل مرة،
                            وتتضمن الآثار الصحية المتباينة اضطراب دقات القلب
                            وارتفاع ضغط الدم ومجموعة من المشاكل النفسية. وتشوهات
                            في الوجه والشيخوخة المبكرة.
                          </li>
                        </ul>
                      </p>
                    </a>
                ...
                >
                  <div className="flex-1 flex-row bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                    ...
                    >
                      ...
                      <div className="w-full font-semiblod text-sm text-gray-900 px-6">
                        تشمل المذيبات المستحضرات الموجودة بمعظم المنازل، مثل
                        الصموغ، ومخفف الطلاء (التينر)، ومزيل طلاء الأظافر
                        (الأسيتون)، ووقود الولاعات، وبخاخات الرذاذ مثل مزيلات
                        العرق. ،
                      </div>
                      ...
                      <p className="text-gray-800 font-serif text-base px-6 mb-5">
                        ...
                        >
                          <li>
                            قد يولد استنشاق المذيبات شعوراً بالنشوة أو ’دفعة
                            إثارة‘ تشبه ما يشعر به الشخص المخمور. وعادة ما تزول
                            تأثيرات المذيب بعد حوالي نصف ساعة. وقد تبدو مخموراً
                            تعتريك حالة من تداخل الكلام، والترنح، وإصدار ضحكات
                            هيستيرية، وعدم قدرة على السيطرة على نفسك،وربما تشعر
                            بعد ذلك بنعاس.{" "}
                          </li>
                        </ul>
                      </p>
            ...
            {/*Subscribe*/}
            <div
              className="container font-sans bg-green-100 rounded mt-8 p-4 md:p-24 text-center"
              dir="ltr"
            >
