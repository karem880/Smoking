          ...
          <div className="w-[90%] mx-auto md:w-[60%] flex flex-col items-center md:items-center md:justify-center md:gap-10 mb-8 md:mb-0 text-slate-600 font-medium ">
            ...
            <ul className=" flex items-start justify-start gap-3 text-lg flex-col">
              <li className="animationl">
                المكان الذي يسعى إلى نشر الوعي والمعرفة حول مشكلة الإدمان
                والمخدرات. نؤمن بأهمية فهم تأثيرات هذه الظاهرة الخطيرة على الفرد
                والمجتمع، ونعمل بجد لتوجيه الأنظار نحو الحلول والدعم.
              </li>

              <li className="animationr">
                في موقعنا، نسعى لتوفير مصادر موثوقة ومعلومات شاملة حول أخطار
                تعاطي المخدرات وتأثيراتها على الصحة البدنية والنفسية. نقدم نصائح
                وإرشادات حول كيفية التعرف على علامات الإدمان والخطوات اللازمة
                للتعافي.
              </li>

              <li className="animationl">
                هدفنا هو تمكين الأفراد بالمعرفة وتقديم الدعم الذي يحتاجونه
                للتغلب على التحديات التي قد تنشأ نتيجة لتعاطي المخدرات. نحن نشجع
                على المشاركة المجتمعية وتبادل الخبرات لبناء مجتمع أكثر صحة
                وعافية.
              </li>

              <li className="animationr">
                انضموا إلينا في رحلتنا لمكافحة الإدمان وتعزيز ثقافة التوعية. من
                خلال توفير المعلومات والدعم، نطمح في خلق بيئة تشجع على اتخاذ
                قرارات صحية وتحفيز الأفراد للابتعاد عن التعاطي والمساهمة في بناء
                مستقبل أفضل.
              </li>

              <li className="animationl">
                شكرًا لزيارتكم لموقعنا، ونتطلع إلى العمل المشترك لنرسم صورة أفضل
                للمستقبل.
              </li>
            </ul>
